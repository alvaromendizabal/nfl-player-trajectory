...
def main():
    ...
    for name, digest in manifest.items():
        ...
        if path.suffix == '.png':
            if not (name.startswith('research/figures/review_') or name in {'research/figures/winner_folds.png', 'research/figures/winner_confirmation.png', 'research/figures/winner_diversity.png', 'research/figures/winner_private_score.png', 'research/figures/winner_horizon.png'}) or not data.startswith(b'\x89PNG\r\n\x1a\n'):
