...
def main():
    p=argparse.ArgumentParser();p.add_argument('stage',choices=['preflight','smoke','prepare','runtime','profile','train','evaluate','replay'])
    ...
    if r.get('status')=='family_profile_budget_stop':raise SystemExit(3)
