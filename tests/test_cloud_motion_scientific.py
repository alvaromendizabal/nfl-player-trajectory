"""Cloud scientific runner restoration tests use only local synthetic archives."""
...
import scripts.cloud_motion_scientific as cloud
...
def test_unsafe_private_member_stops_before_restoration(tmp_path, monkeypatch):
    archive = tmp_path / "inputs.tar.gz"
